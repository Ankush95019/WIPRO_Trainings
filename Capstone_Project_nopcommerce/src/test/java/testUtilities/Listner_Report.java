...
import testCases.AllTestCase;

public class Listner_Report extends BaseTest implements ITestListener{
    ...
    public void onStart(ITestContext context) {
        ...
        htmlReport.config().setDocumentTitle("nopCommerce Project Report");
    ...
    public void onTestFailure(ITestResult result) {
        ...
        driver = ((AllTestCase) testClass).getBaseDriver();
